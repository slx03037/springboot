...
public class BoxController {
    ...
    public void createPdf(@RequestParam("file") MultipartFile file,HttpServletResponse response) throws IOException {
        String uploadPath = "D:\\workspace-github-project\\my-spring-all-com.xinwen.mybatis.node01.service\\spring-boot-pdf-excel-word\\spring-boot-pdf-box\\src\\main\\resources\\file"; // 改这里
        ...
        // File file = new File("D:\\workspace-github-project\\my-spring-all-com.xinwen.mybatis.node01.service\\spring-boot-pdf-excel-word\\spring-boot-download-upload\\src\\main\\resources\\file\\号卡资源.txt"); // 改这里
