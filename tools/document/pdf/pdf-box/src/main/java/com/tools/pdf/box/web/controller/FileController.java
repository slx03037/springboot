...
import com.tools.pdf.box.web.utils.CommonUtil;
...
public class FileController {
    ...
    public void pdfToDoc(@RequestParam("pdfFile") MultipartFile pdfFile, HttpServletResponse response) throws Exception {
        ...
        String path="D:\\workspace-github-project\\my-spring-all-com.xinwen.mybatis.node01.service\\spring-boot-pdf-excel-word\\spring-boot-pdf-word\\src\\main\\resources\\file";
