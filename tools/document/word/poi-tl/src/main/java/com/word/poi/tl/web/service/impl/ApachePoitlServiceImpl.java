 ...
 * @description:
 * @author: shenlx
 * @create: 2023-07-12 23:12
 **/

@Service
public class ApachePoitlServiceImpl implements ApachePoitlService {

    private static final String TEMPLATE_PATH = "/file/demo_template.docx";
    ...
    public void generateCharts() {
        ...
        //插入图片
        var picData = new PictureContentData();
        picData.setWidth(200).setHeight(160).setPicType(PicTypeEnum.JPG).setFile(new File("D:\\workspace-github-project\\my-spring-all-com.xinwen.mybatis.node01.service\\spring-boot-pdf-excel-word\\spring-boot-file-poi-tl-report\\src\\main\\resources\\file\\1.jpeg"))
        ...
        //生成word
        OperateWordManage.generateWordContent(templateFile, "D:\\workspace-github-project\\my-spring-all-com.xinwen.mybatis.node01.service\\spring-boot-pdf-excel-word\\spring-boot-file-poi-tl-report\\src\\main\\resources\\file\\output.docx", generates);
    }
}
