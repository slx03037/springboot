...
public class PdfController {
    ...
    public ResponseEntity<?> pdfReview() throws IOException {
        File file = new File("D:\\workspace-github-project\\my-spring-all-com.xinwen.mybatis.node01.service\\spring-boot-pdf-excel-word\\spring-boot-file-online\\src\\main\\resources\\output.pdf");
