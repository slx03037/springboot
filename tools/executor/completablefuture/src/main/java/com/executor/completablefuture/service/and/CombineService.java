...
public class CombineService {
    ...
    public void defaultThenCombine() throws ExecutionException, InterruptedException {
        ...
        CompletableFuture<Menu> menuCompletableFuture = userCompletableFuture.thenCombine(CompletableFuture.supplyAsync(() -> {
            long startTime = System.currentTimeMillis();
            try {
                Thread.sleep(1000);
            } catch (InterruptedException e) {
