...
import com.database.elasticsearch.basic.service.ElasticsearchAddService;
...
@Service
@Slf4j
public class ElasticsearchAddServiceImpl implements ElasticsearchAddService {
...
//        users.add(new User("4","冬梅",20,"女"));
            ...
            users.add(new UserDO("11", "zhaosi", 20, "男"));
            users.add(new UserDO("22", "awang", 25, "男"));
            users.add(new UserDO("33", "liuyifei", 22, "女"));
            users.add(new UserDO("44", "dongmei", 20, "女"));
            users.add(new UserDO("55", "zhangya", 30, "女"));
            users.add(new UserDO("66", "liuyihu", 32, "男"));
            //方式一
